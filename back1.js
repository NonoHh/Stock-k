...
setTimeout(function(){transaction.add_buy(1000001, 600002, 28, 80, function(a){buy_id=a; console.log(a);});},4000);
setTimeout(function(){transaction.add_sell(1000056, 600002, 19, 45, function(a){});},5000);
setTimeout(function(){transaction.cancel_buy(buy_id, function(a){});},6000);
